...
const CUSTOMERS_BASE = [
  ...
  // Ejected sub-accounts. Active=false → only visible on the "Inactive" tab.
  // In live mode these would be backed by server-side tracking of ejected
  // members; the Partner API itself does not return ejected accounts.
  {
    id: 'sub-5a2d18',
    accountId: '5a2d18b04e7c',
    name: 'Skyline Capture',
    industry: 'Photogrammetry / Mapping',
    region: 'us-west-002',
    plan: 'Reseller — Tier 3',
    groupId: 'neocloud-internal',
    storageBytes: 0,
    ...
    growth: 0,
    activeBuckets: 0,
    contactEmail: 'ops@skylinecapture.io',
    onboarded: '2024-05-22',
    active: false,
    ejectedAt: '2026-03-08',
  },
  {
    id: 'sub-d471f0',
    accountId: 'd471f0a98b23',
    name: 'Quill Archive',
    industry: 'Legal / Records Retention',
    region: 'us-east-005',
    plan: 'Partner — Custom',
    groupId: 'neocloud-external',
    storageBytes: 0,
    ...
    growth: 0,
    activeBuckets: 0,
    contactEmail: 'admin@quillarchive.com',
    onboarded: '2023-09-14',
    active: false,
    ejectedAt: '2026-01-30',
  },
];
